...
typedef KeysVars = {
    var keyboard:Map<String, FlxKey>; // Map to store "FlxKey" values
    var gamepad:Map<String, FlxGamepadInputID>;  // Map to store "FlxGamepad" values
}
...
class RawKeys{
    ...
    // Initialize the data variable with maps for FlxKey and FlxGamepad values
    public static var data:KeysVars = {
        keyboard: new Map<String, FlxKey>(),
